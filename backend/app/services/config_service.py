...
class ConfigService:
    ...
    DEFAULT_CONFIGS: list[dict[str, Any]] = [
        ...
        {"key": "ipguard_stale_threshold_minutes", "value": "12", "category": "compliance",
         ...
         "is_readonly": False},
        {"key": "compliance_cooldown_minutes", "value": "10", "category": "compliance",
         "value_type": "int", "description": "Compliance transition cooldown period in minutes (1-60)",
         "is_readonly": False},
        {"key": "compliance_ip_grace_minutes", "value": "10", "category": "compliance",
         "value_type": "int", "description": "IP change grace period in minutes before downgrade allowed (1-60)",
         "is_readonly": False},
