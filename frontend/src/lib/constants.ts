...
export const NAV_ITEMS: NavItem[] = [
  ...
  { path: '/compliance-scopes', label: 'Compliance Scope', iconName: 'Filter', adminOnly: true, requiredPermission: 'compliance:read' },
  { 
...
export const API_ENDPOINTS = {
  ...
  TERMINALS_EXPORT: '/terminals/export',
  WHITELIST: '/whitelist/',
  ...
  COMPLIANCE_SCOPE_TOGGLE: '/compliance-scope/',
  SETTINGS: '/settings/',
  ...
  BACKUP_WHITELIST: '/backup/whitelist',
  BACKUP_WHITELIST_LIST: '/backup/whitelist/list',
  BACKUP_WHITELIST_RESTORE: '/backup/whitelist/restore/{{filename}}',
  BACKUP_CONTENTS: '/backup/{{filename}}/contents',
